...
if not SECRET_KEY:
    raise ValueError(
        ...
        "Please create a backend/.env file. See backend/.env.example for reference."
    )
...
SPECTACULAR_SETTINGS = {
    ...
    'DESCRIPTION': 'Production-ready REST API for Healthcare Appointment Booking Platform (Practo clone)',
    'VERSION': '1.0.0',
